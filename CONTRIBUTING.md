# Contributing to Metal Server

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Metal Server? Welcome! Please read this
...
You can help Metal Server by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/metal-server/issues?state=open)
...
If you find a bug - behaviour of Metal Server code or documentation
...
[GitHub issue tracker for Metal Server](https://github.com/openflighthpc/metal-server/issues/new)
to report the issue.
...
We want to improve the quality of Metal Server and good bug reports are
...
Metal Server is Open Source and comes without warranty.
...
Metal Server in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Metal Server and really improve it. The more
...
applied to Metal Server itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/metal-server). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Metal Server developers also have their regular
